...
def colour_hash_str(digest: str) -> str:
    ...
    """
    background = int(digest, base=16) % 256
    foreground = 15 if background in (0, 1, 52, 88, 232, 233, 234, 235, 236, 237) else 0
    return f"\033[38:5:{foreground}m\033[48:5:{background}:m{digest}\033[m"
